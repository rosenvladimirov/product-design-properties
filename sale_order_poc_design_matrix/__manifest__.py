...
# by the AGPL-3.0-or-later.
{
    ...
    # 🔑 AGPL лист (ADR sale-order-poc/0005): стъпва на AGPL матрицата, затова
    # НИКОЙ LGPL или OPL модул не зависи от него. НЕ зависи от конфигуратора
    # на продажбата (ADR sale-order-poc/0019): върви и в завод, който отваря
    # матрицата само в производството. Частта на конфигуратора е в
