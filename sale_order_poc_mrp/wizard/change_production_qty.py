...
class ChangeProductionQty(models.TransientModel):
    ...
    def change_prod_qty(self):
        # ядрото мащабира суровините линейно (_update_raw_moves); след него
        # product_qty вече е новото и експлозията дава абсолютното количество
        res = super().change_prod_qty()
        self.mo_id._poc_refresh()
        return res
